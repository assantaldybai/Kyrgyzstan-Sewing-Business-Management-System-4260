...
BEGIN
  ...
  VALUES (
    ...
    p_advance_payment, p_delivery_date, p_notes
  )
  ...
  IF v_template_id IS NOT NULL THEN
    ...
    LOOP
      ...
      VALUES (
        ...
        template_operation.equipment_type_id, template_operation.base_rate,
        template_operation.estimated_time_minutes, 'pending', template_operation.description
      );
  ...
  SELECT 
    p_factory_id, m.id, v_order_id, v_lot_id, -(p_quantity * 1.2), 'reserved', 'pending', m.cost_per_unit,
  ...
  SELECT 
    p_factory_id, m.id, v_order_id, v_lot_id, -p_quantity, 'reserved', 'pending', m.cost_per_unit,
